const NOTIF_SEND = 'ReduxTest/notifs/NOTIF_SEND';
const NOTIF_DISMISS = 'ReduxTest/notifs/NOTIF_DISMISS';
const NOTIF_CLEAR = 'ReduxTest/notifs/NOTIF_CLEAR';
const NOTIF_CLEAR_ALL = 'ReduxTest/notifs/NOTIF_CLEAR_ALL';
